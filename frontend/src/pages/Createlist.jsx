      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row'>
        <div className='flex flex-col gap-4 flex-1 ml-5'>
          ...
          <div className='flex flex-wrap gap-6 mt-5'>
            ...
            <div className='flex items-center gap-2'>
              <input onChange={handleChange} value={formData.bathrooms} type='number' id='bathrooms' className='border p-3 rounded-lg border-gray-300' />
              <p>Baths</p>
            </div>
            <div className='flex items-center gap-2'>
              <input onChange={handleChange} value={formData.regularprice} type='number' id='regularprice' className='border p-3 rounded-lg border-gray-300' />
            ...
            <div className='flex items-center gap-2'>
              <input onChange={handleChange} value={formData.discountedprice} type='number' id='discountedprice' className='border p-3 rounded-lg border-gray-300' />
              <p>Discount price</p>
              <span className='text-sm'>($/ month)</span>
            </div>
          </div>
